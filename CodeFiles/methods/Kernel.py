...
# =============================================================================
# Defining the categorical overlap kernel
...
class MixtureViaSumAndProduct(GPy.kern.Kern):
    ...
    def K(self, X, X2=None):
        ...
        product_track = k1_xx * k2_xx
        # print(product_track.shape)
...
class CategoryOverlapKernel(GPy.kern.Kern):
    ...
    """
    def __init__(self, input_dim, variance=1, active_dims=None,name='catoverlap'):
        # print(input_dim)
        super().__init__(input_dim, active_dims=active_dims, name= 'catoverlap')
